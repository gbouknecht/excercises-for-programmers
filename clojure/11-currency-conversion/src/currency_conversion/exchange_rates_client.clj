...
(defprotocol ExchangeRatesClient
  ...
  (get-rates [this base-currency-code currency-codes]
    "Returns a map of rates, mapping the currency code on the rate the base
    currency is exchanged for. For example: {\"AED\" 3.672538, \"AFN\" 66.809999}.
